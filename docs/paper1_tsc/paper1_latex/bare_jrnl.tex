...
% --- Headline result macros (fill once, after the campaign completes) -------
% Single source of truth so the Abstract, Discussion (Sec.~VII) and Conclusion
% (Sec.~VIII) can never disagree. Replace each bracketed placeholder with the
% measured value; the percent sign stays in the surrounding text.
\newcommand{\ImproveFixed}{[X]}        % travel-time reduction vs.\ fixed-time
\newcommand{\ImproveMaxP}{[Y]}         % travel-time reduction vs.\ max-pressure
\newcommand{\ImproveStrongest}{[Y']}   % reduction vs.\ strongest classical baseline
\newcommand{\RetainPriv}{[Z]}          % percent of privileged performance retained
\newcommand{\RestrictionCost}{[W]}     % information-restriction cost (proxy vs.\ priv.)
% ---------------------------------------------------------------------------
