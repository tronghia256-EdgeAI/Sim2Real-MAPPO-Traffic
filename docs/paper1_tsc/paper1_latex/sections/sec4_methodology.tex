...
isolated by the delay-term ablation reported in Section~\ref{sec:ablations}.
...
policies exceeds $1.5\times$ the target KL of $0.015$ (i.e., $0.0225$). The complete training loop is summarized in Algorithm~\ref{alg:mappo}.
...
\FOR{iteration $= 1, 2, \ldots, \text{max\_iterations}$}
    ...
    \FOR{epoch $= 1$ to $10$}
        ...
        \IF{approximate KL divergence $> 1.5 \times 0.015$}
