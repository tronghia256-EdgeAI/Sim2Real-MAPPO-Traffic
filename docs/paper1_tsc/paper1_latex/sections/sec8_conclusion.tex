...
travel time over the strongest classical baseline by $[Y]\%$, while the gap to a privileged
upper bound---the information-restriction cost---was only $[X]\%$. The policy further degraded
