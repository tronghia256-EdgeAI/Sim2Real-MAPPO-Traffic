...
basis~\cite{zhang2022_bytetrack,khanam2024_yolov11}; tightening them with a
measured feature-recovery study on labeled frames is left to the companion field
deployment. The full parameterization, per-feature provenance, and the
