...
(the information-restriction cost of Section~\ref{sec:restriction_cost}).
...
$0$--$2\times$ magnitude sweep (Sections~\ref{sec:noise_model} and~\ref{sec:robustness_noise}).
