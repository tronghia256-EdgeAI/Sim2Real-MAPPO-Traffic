...
Section~\ref{sec:generalization}. We rigorously distinguish count share from
at a motorcycle passenger-car-unit (PCU) equivalence of $\approx 0.29$~\cite{cao_sano_hanoi},
...
conflict directly with the anti-starvation objective of the reward
...
lull, ramps to a sustained demand peak over $1500$--$3000$~s, eases to
over $3600$--$4800$~s, and finally tapers back to off-peak, exercising the controllers
